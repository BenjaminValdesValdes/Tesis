...
\begin{itemize}
    ...
    \item \textbf{Políticas de Horario Operativo vs. Operación 24/7:} A nivel de software, la plataforma contempla la posibilidad de configurar reglas de negocio con restricciones horarias (ej. denegar la apertura automática fuera de la jornada institucional). Sin embargo, a nivel de infraestructura física, el Nodo de Borde se mantiene en operación continua (24/7) con el fin de garantizar la estabilidad térmica del hardware, preservar la disponibilidad del sistema y eliminar latencias de arranque ante eventuales accesos autorizados fuera del horario habitual.
