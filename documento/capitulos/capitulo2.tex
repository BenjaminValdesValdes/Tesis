...
La planificación temporal y el desglose de tareas del proyecto integral de titulación se han estructurado mediante un cronograma de actividades (Carta Gantt). Esta planificación abarca todo el ciclo de vida académico y de ingeniería (desde la formulación y entrega del anteproyecto, hasta el despliegue del prototipo, validación del modelo y redacción final del documento de tesis). El cronograma se divide en dos niveles de detalle: una vista general de macro-actividades y un desglose jerárquico exhaustivo. Ambos diagramas de Gantt se encuentran documentados en el \textbf{Anexo~\ref{anexo:cronograma}: Cronograma General y Detallado}.
