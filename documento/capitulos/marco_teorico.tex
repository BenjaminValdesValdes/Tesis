...
% [PENDIENTE: Párrafo introductorio sobre los desafíos del mundo real.]

\subsection{Técnicas de Preprocesamiento Crítico}
% Uso de filtros bilaterales para reducción de ruido, normalización min-max,
% conversión a escala de grises y algoritmos de mejora de contraste (como
% CLAHE).
% [PENDIENTE]

\subsection{Módulos de Mejora Dinámica}
% Tecnologías como CPA-Enhancer para optimizar imágenes degradadas por
% lluvia, niebla o baja luminosidad.
% [PENDIENTE]

\subsection{Datos Sintéticos y Aumento (\textit{Data Augmentation})}
% El rol de las redes GAN para entrenar modelos robustos ante la escasez
% de datos reales.
% [PENDIENTE]
...
% [PENDIENTE: Párrafo introductorio sobre la importancia del seguimiento
% temporal en un sistema de control de acceso vehicular.]

\subsection{Algoritmos de \textit{Tracking}}
% Uso de SORT y DeepSort para vincular placas entre cuadros de video,
% evitando detecciones duplicadas y permitiendo la redundancia temporal.
% [PENDIENTE]

\subsection{Votación Temporal e Interpolación}
% Cómo promediar los resultados de varios cuadros para elevar la precisión
% final del acceso.
% [PENDIENTE]
...
% [PENDIENTE: Párrafo introductorio que aterrice el proyecto a la realidad
% local chilena.]

\subsection{Estándares de Patentes en Chile}
% Reconocimiento de los 5 formatos civiles, incluyendo la transición al
% sistema de 5 letras y el nuevo estándar de Movilidad Sostenible
% (Patentes Verdes).
% [PENDIENTE]

\subsection{Requerimientos Funcionales del Prototipo}
% Presupuesto de latencia (<100ms), consumo energético (<10W) y gestión
% de logs administrativos.
% [PENDIENTE]
