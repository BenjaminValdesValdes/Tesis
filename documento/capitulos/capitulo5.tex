...
Para evitar arbitrariedades en la determinación de la vida útil de los activos y respaldar rigurosamente el análisis económico, la depreciación contable se fundamenta en las **Tablas de Vida Útil de los Bienes Físicos del Activo Fijo** fijadas por el **Servicio de Impuestos Internos (SII)** de Chile (Resolución Exenta N° 43 del 2002 y actualizaciones vigentes) y las pautas metodológicas de formulación de proyectos MIDESO:
...
Como todas las vidas útiles de los componentes superan el horizonte de evaluación de 5 años del proyecto, **no se requiere modelar una reinversión de equipos en el Año 3**. 

Al término del período de evaluación (Año 5), los activos no han concluido su vida útil física ni contable, por lo que conservan un **Valor Libro Remanente (Valor Residual)**. Este valor se calcula restando la depreciación acumulada de 5 años al costo original de los equipos y se rescata como un ingreso de capitales en el flujo del Año 5.
...
Siguiendo la estructura formal de evaluación de proyectos, el flujo financiero se desglosa en el **Flujo de Caja Operacional** (beneficios operativos menos OPEX) y el **Flujo de Caja de Capitales** (inversión inicial CAPEX en Año 0 y la recuperación del Valor Residual en el Año 5). 
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{2.8cm}|r|r|r|r|r|r|}
        ...
        Inversión Inicial (CAPEX) & -\$3.067.187 & \$0 & \$0 & \$0 & \$0 & \$0 \\ \hline
        Recuperación Valor Residual & \$0 & \$0 & \$0 & \$0 & \$0 & \$925.480 \\ \hline
        \textbf{Subtotal Flujo Capitales} & \textbf{-\$3.067.187} & \textbf{\$0} & \textbf{\$0} & \textbf{\$0} & \textbf{\$0} & \textbf{\$925.480} \\ \hline
        \hline
        \textbf{FLUJO DE CAJA NETO} & \textbf{-\$3.067.187} & \textbf{\$1.501.670} & \textbf{\$1.501.670} & \textbf{\$1.501.670} & \textbf{\$1.501.670} & \textbf{\$2.427.150} \\ \hline
    \end{tabular}
...
\begin{enumerate}
    ...
    \begin{align}
        \text{VAN} = & \, -\$3.067.187 + \sum_{t=1}^{4} \frac{\$1.501.670}{(1{,}055)^t} + \frac{\$2.427.150}{(1{,}055)^5} \nonumber \\
        = & \, \$4.053.486 \text{ CLP}
    \end{align}
    Puesto que $\text{VAN} = \$4.053.486 \text{ CLP} > 0$, el proyecto es altamente rentable e incrementa el patrimonio institucional en más de 4 millones de pesos.
    
    \item \textbf{Tasa Interna de Retorno (TIR):} Representa el rendimiento promedio anual del capital invertido:
    \begin{equation}
        0 = -\$3.067.187 + \sum_{t=1}^{4} \frac{\$1.501.670}{(1+\text{TIR})^t} + \frac{\$2.427.150}{(1+\text{TIR})^5} \implies \text{TIR} = 42{,}93\%
    \end{equation}
    Al ser la $\text{TIR} = 42{,}93\% \gg 5{,}5\%$, la inversión supera holgadamente la tasa social de exigencia del Estado.
    
    \item \textbf{Periodo de Recuperación de Capital (PRC):} Cuantifica el tiempo requerido para amortizar la inversión inicial mediante los flujos operacionales netos:
    \begin{equation}
        \text{PRC} = \frac{\$3.067.187 \text{ CLP}}{\$1.501.670 \text{ CLP/año}} \approx 2{,}04 \text{ años}
    \end{equation}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{5.5cm}|r|p{3.5cm}|}
        ...
        Valor Actual Neto (VAN) & \$4.053.486 CLP & Aceptable (VAN > 0) \\ \hline
        Tasa Interna de Retorno (TIR) & 42,93\% & Excelente (TIR > $r$) \\ \hline
