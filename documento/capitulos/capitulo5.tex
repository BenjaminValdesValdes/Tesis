...
Este CAPEX total de \textbf{\$3.067.137 CLP} se compone en un 77,15\% por la adquisición de Equipos de Cómputo y Visión para la capa inteligente (\$2.366.425 CLP), en un 7,20\% por insumos de Infraestructura Pasiva y Montaje (\$220.712 CLP) respaldados en cotizaciones de mercado (véase Anexo~\ref{anexo:cotizaciones}), y en un 15,65\% exclusivamente por el costo de la Mano de Obra Especializada para su instalación y puesta en marcha (\$480.000 CLP).
...
En la situación actual (sin automatización), los funcionarios de conserjería deben interrumpir sus labores de seguridad, vigilancia y atención a los usuarios para verificar de manera visual a cada conductor y accionar manualmente el portón vehicular a través de control remoto. Considerando un flujo promedio de 30 a 40 vehículos diarios, donde cada ciclo de apertura, verificación, cierre y la consecuente interrupción de sus tareas de vigilancia principal consume entre 3 y 4 minutos, se establece un escenario conservador de \textbf{2 horas diarias} de tiempo efectivo dedicado exclusivamente a esta labor repetitiva.
...
Para evitar arbitrariedades en la determinación de la vida útil de los activos y respaldar rigurosamente el análisis económico, la depreciación contable se fundamenta en las \textbf{Tablas de Vida Útil de los Bienes Físicos del Activo Fijo} fijadas por el \textcite[Resolución Exenta N° 43]{SIIServicioImpuestos} y las pautas metodológicas de formulación de proyectos MIDESO \parencite{METODOLOGIAGENERAL2025}:

\begin{enumerate}
    \item \textbf{Equipos de Procesamiento y Cómputo (Jetson Orin Nano, Switch PoE y Relé):} Clasificados según la normativa del SII en la categoría de \textit{``Sistemas computacionales, computadores, periféricos, y similares''}, a los cuales se les asigna una vida útil normal de \textbf{6 años}. Subtotal: \$858.135 CLP. Depreciación anual: \$143.023 CLP/año.
    \item \textbf{Óptica y Seguridad CCTV (Cámaras LPR Dahua ITC413):} Clasificadas en la categoría de \textit{``Equipos de vigilancia y detección y control de incendios, alarmas''}. Dada su naturaleza de equipos electrónicos de intemperie para operación industrial continua (protección IP67 e IK10), se adopta la vida útil normal del SII de \textbf{7 años}. Subtotal: \$1.476.790 CLP. Depreciación anual: \$210.970 CLP/año.
    \item \textbf{Infraestructura Pasiva y Obras Civiles (Pedestal, Gabinete IP65, Cableado UTP/Control, Conduit PVC y Hormigón H20):} Clasificados en la categoría de \textit{``Instalaciones en general (ejemplos: eléctricas, de oficina, etc.)''}, con una vida útil normal de \textbf{10 años}. Subtotal: \$252.212 CLP. Depreciación anual: \$25.221 CLP/año.
\end{enumerate}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{4.2cm}|c|r|r|r|}
        ...
        Óptica y CCTV (Cámaras Dahua) & 7 años & \$1.476.790 & \$210.970 & \$421.940 \\ \hline
        Infraestructura Pasiva y Estructura & 10 años & \$252.212 & \$25.221 & \$126.110 \\ \hline
        \hline
        \textbf{TOTALES} & -- & \textbf{\$2.587.137} & \textbf{\$379.214} & \textbf{\$691.070} \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{2.8cm}|r|r|r|r|r|r|}
        ...
        Recuperación Valor Residual & \$0 & \$0 & \$0 & \$0 & \$0 & \$691.070 \\ \hline
        \textbf{Subtotal Flujo Capitales} & \textbf{-\$3.067.137} & \textbf{\$0} & \textbf{\$0} & \textbf{\$0} & \textbf{\$0} & \textbf{\$691.070} \\ \hline
        \hline
        \textbf{FLUJO DE CAJA NETO} & \textbf{-\$3.067.137} & \textbf{\$1.975.740} & \textbf{\$1.975.740} & \textbf{\$1.975.740} & \textbf{\$1.975.740} & \textbf{\$2.666.810} \\ \hline
        \textbf{FLUJO DE CAJA ACUMULADO} & \textbf{-\$3.067.137} & \textbf{-\$1.091.397} & \textbf{\$884.343} & \textbf{\$2.860.083} & \textbf{\$4.835.823} & \textbf{\$7.502.633} \\ \hline
    \end{tabular}
...
Para validar la rentabilidad y fundamentar la toma de decisiones, se calculan el Valor Actual Neto (VAN), la Tasa Interna de Retorno (TIR) y el Periodo de Recuperación de Capital (PRC) sobre el Flujo de Caja Neto y su respectivo acumulado, considerando la Tasa Social de Descuento del $r = 5{,}5\%$ anual vigente fijada por el \textcite{MinisterioDesarrolloSocial}.

\begin{enumerate}
    \item \textbf{Valor Actual Neto (VAN):} Expresa la riqueza neta actualizada generada por el proyecto:
    \begin{align}
        \text{VAN} = & \, -\$3.067.137 + \sum_{t=1}^{4} \frac{\$1.975.740}{(1{,}055)^t} + \frac{\$2.666.810}{(1{,}055)^5} \nonumber \\
        = & \, \$5.898.595 \text{ CLP}
    \end{align}
    Puesto que $\text{VAN} = \$5.898.595 \text{ CLP} > 0$, el proyecto es altamente rentable e incrementa el patrimonio institucional en más de 5 millones de pesos.
    
    \item \textbf{Tasa Interna de Retorno (TIR):} Representa el rendimiento promedio anual del capital invertido:
    \begin{equation}
        0 = -\$3.067.137 + \sum_{t=1}^{4} \frac{\$1.975.740}{(1+\text{TIR})^t} + \frac{\$2.666.810}{(1+\text{TIR})^5} \implies \text{TIR} = 59{,}47\%
    \end{equation}
    Al ser la $\text{TIR} = 59{,}47\% \gg 5{,}5\%$, la inversión supera holgadamente la tasa social de exigencia del Estado.
    ...
    \end{equation}
    La inversión se recupera íntegramente en \textbf{1 año, 6 meses y 18 días} de funcionamiento del sistema.
\end{enumerate}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{5.5cm}|r|p{3.5cm}|}
        ...
        Valor Actual Neto (VAN) & \$5.898.595 CLP & Aceptable (VAN > 0) \\ \hline
        Tasa Interna de Retorno (TIR) & 59,47\% & Excelente (TIR > $r$) \\ \hline
        Periodo de Recuperación (PRC) & 1,55 años & Retorno Rápido (< 2 años) \\ \hline
    \end{tabular}
    \label{tab:indicadores}
\end{table}

En conclusión, el estudio de factibilidad económica demuestra de manera objetiva y técnicamente justificada que la implementación del nodo de borde inteligente bajo la metodología \textit{Retrofit} es una inversión altamente rentable para la Universidad Tecnológica Metropolitana, garantizando el retorno del capital en el segundo año y generando un valor económico neto de más de 5,8 millones de pesos bajo la normativa del Sistema Nacional de Inversiones de Chile.
