...
4. **Trazabilidad Teórica Obligatoria:** Toda decisión tecnológica o arquitectónica para el proyecto (tamaño de modelos, algoritmos, hardware, frameworks) debe estar sustentada previamente en el Marco Teórico. Si se propone una nueva decisión que no está documentada, Antigravity debe pausar, notificar al usuario, y redactar el sustento para el Marco Teórico antes de continuar con la implementación.
5. **Integridad de Citas Bibliográficas:** Nunca alterar afirmaciones específicas ligadas a una cita bibliográfica para forzar consistencia con decisiones del proyecto. Esto genera falacias de atribución. Las citas deben reflejar estrictamente lo que los autores originales probaron. Si el proyecto usa una tecnología superior (ej. YOLOv12s) basada en técnicas probadas en versiones anteriores (ej. CLAHE en YOLOv11), se debe mantener la cita original intacta y, en los capítulos de Desarrollo, explicar la extrapolación lógica.
